...
<style type="text/css">
	#main
	{
		...
		border-radius: 30px;
		border:4px solid hsla(0, 100%, 30%, 0.7);
	}
...
<body background="background.jpg">
	<section id="main">
		<center><img src="img.png" style="width: 40vw; height: 20vh;"></center>
	<div id="dataupdate" style="position: absolute; height: 100vh;width: 100vw;">
		<form style="background-color: pink; width: 70vw;" method="post" action="update.php" id="dataupto" onsubmit="return updateformme()">
			...
			<label>Rollnumber:</label> <input class="adinp" type="text" id="newrolno" name="newrolno"><br><br>
			<label>Name:</label><input class="adinp" type="text" id="newnam" name="newnam"><br>
			<label>Class:</label><input class="adinp" type="text" id="newclas" name="newclas"><br>
			<label>Phonenumber:</label><input class="adinp" type="text" id="newpno" name="newpno"><br>
	...
	<form method="post" action="insert.php" id="foadd" onsubmit="return formsubmit()">
		<center>
			<input class="adinp" type="text" name="anam" placeholder="name" required>
			<input class="adinp" type="text" name="aroln" placeholder="rollnumber" required>
			<input class="adinp" type="text" name="acls" placeholder="class" required>
			<input class="adinp" type="text" name="apno" placeholder="phonenumber" required>
