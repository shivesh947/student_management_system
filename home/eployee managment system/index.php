...
<style type="text/css">
	#main
	{
		...
		width: 70vw;
		margin-left: 15vw;
		background-color: hsla(0, 30%, 60%, 0.7);
		border-radius: 30px;
...
<body background="background.jpg" style="background-size: cover;">
	<section id="main">
		<center><h1>Employee Managment System</h1></center>
	<div id="dataupdate" style="position: absolute; height: 100vh;width: 100vw;">
		<form style="background-color: pink; width: 70vw;" method="post" action="update.php" id="dataupto" onsubmit="return updateformme()">
			...
			<label>Employee Id number:</label> <input class="adinp" type="text" id="newrolno" name="newrolno"><br><br>
			<label>Employee Name:</label><input class="adinp" type="text" id="newnam" name="newnam"><br>
			<label>Joining year:</label><input class="adinp" type="text" id="newclas" name="newclas"><br>
			<label>Employee Phonenumber:</label><input class="adinp" type="text" id="newpno" name="newpno"><br>
	...
	<form method="post" action="insert.php" id="foadd" onsubmit="return formsubmit()">
		<center>
			<input class="adinp" type="text" name="anam" placeholder="Employee name" required>
			<input class="adinp" type="text" name="aroln" placeholder="Employee Id number" required>
			<input class="adinp" type="text" name="acls" placeholder="Joining year" required>
			<input class="adinp" type="text" name="apno" placeholder="Employee phonenumber" required>
		...
		<div id="datashow">
			...
			<table border="3px" id="dataview" style="width: 70vw; height: 100%; font-size: 35px;">
				<thead>
					...
					<td colspan="2"><b>Employee Phonenumber</b></td>
				   </tr>
			   </thead>
<?php
